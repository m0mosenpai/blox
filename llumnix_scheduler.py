...
def parse_args(parser):
    ...
    """
    parser.add_argument(
        "--scheduler", default="Llumnix", type=str, help="Name of the scheduling strategy"
    )
...
def main(args):
    # TO-DO: Llumnix Placement Policy
    placement_policy = placement.JobPlacement(args)
    scheduling_policy = schedulers.Llumnix(args)
    # TO-DO: Llumnix Admission Policy
